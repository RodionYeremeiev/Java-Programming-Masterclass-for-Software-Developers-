 ...
 * basic ingredients of the hamburger, name, meat, price, and breadRollType.
 * The price variable should be of type double, while the other three are of type String.
 * A constructor will be needed to accept these four values as parameters when creating
 * a new hamburger.
 *
 ...
 * Four(4) for adding up to four additions to the hamburger and one(1) for printing out
 * an itemized listing of the final hamburger with addons, if any, and the total price.
 ...
 * for the total price just mentioned. In this class, the four(4) methods defined in the
 * Hamburger class for including additional toppings must each be overridden so that a message
