...
public class Main {
	...
	// write your code here
        printMegaBytesAndKiloBytesStupid(5000);
        printMegaBytesAndKiloBytes(5000);
    }

    public static void printMegaBytesAndKiloBytesStupid(int kiloBytes) {
        int megaBytes = kiloBytes / 1000;
        int leftOverKyloBytes = kiloBytes % 1024;
        if (kiloBytes < 0) {
            System.out.println("Invalid Value");
        } else if (kiloBytes == 0) {
            System.out.println(0 + " KB = " + 0 + " MB and " + 0 + " KB");
        } else if (kiloBytes % 1000 == 0) {
            System.out.println(kiloBytes + " KB = " + (megaBytes - 1) + " MB and " + leftOverKyloBytes + " KB");
        } else {
            System.out.println(kiloBytes + " KB = " + megaBytes + " MB and " + leftOverKyloBytes + " KB");
        }
    }
